...
const Constructon = () => {
  ...
  return (
    <div>
      <HeroSection
        heroImage={heroImage}
        title={t("division.construction.heroSection.title")}
        descripton={t("division.construction.heroSection.description")}
      />
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row p-4">
        <div className="w-full md:w-2/4 p-2">
          <p className="text-lg">
            {t("division.construction.paragraph1")}
            <br />
            {t("division.construction.paragraph2")}
            <br />
            {t("division.construction.paragraph3")}
            <br />
            {t("division.construction.paragraph4")}
          </p>
        </div>
        <div className="w-full md:w-2/4 p-2">
