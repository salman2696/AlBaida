              ...
              <div className="relative text-white lg:w-1/2 lg:mx-6 def-title">
                ...
                <div className="mt-6 md:mt-8">
                  ...
                  <div className="flex mt-4 -mx-1.5 ">
                    ...
                    <a
                      className="mx-1.5 text-white transition-colors duration-300 transform hover:text-[#0073b2]"
                      href="#"
                    >
                      <svg
                        className="w-8 h-8"
                    ...
                    <a
                      className="mx-1.5 text-white transition-colors duration-300 transform hover:text-[#ec4899]"
                      href="#"
                    >
                      <svg
                        className="w-8 h-8"
                  ...
                  <form className="mt-6">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        className="block w-full px-5 py-3 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-red-400 focus:ring-red-300 focus:ring-opacity-40  focus:outline-none focus:ring"
                      />
                    </div>
