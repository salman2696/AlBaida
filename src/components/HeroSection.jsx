...
const HeroSection = ({ title, subtitle, descripton }) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative z-10 text-white p-4 max-w-7xl mx-auto">
        <h1 className="mb-4">
          <span className="text-5xl md:text-7xl font-extrabold block">{title}</span>
          <span className="text-2xl md:text-4xl font-thin block">{subtitle}</span>
        </h1>
